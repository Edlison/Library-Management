        ...
        <el-table-column prop="operation" label="操作">
          <template slot-scope="scope">
            ...
            <template v-else-if="scope.row.action == 'add'">
              <el-button size="mini" @click="click_add(scope.row, scope.$index)"
                >新增</el-button
              >
              <el-button
                size="mini"
    ...
    return {
      form: {
        datas: [
          ...
          { id: 2, name: "李四", age: 32 ,status:1},
          { id: 3, name: "李四", age: 32 ,status:2},
        ],
      },
