<template>
  <div class="dormitory" style="margin: 10px 0  0 10px ">
    <div class="searchWord">
      ...
      <el-input v-model="search" style="display: inline-block;width: 1000px" 
        placeholder="请输入搜索内容">
      </el-input>
    </div>
    <div class="dormitoryData">
      <el-table
        ...
        <el-table-column label="ISBN" prop="book_ISBN">
        </el-table-column>
    ...
    data () {
      return {
        dormitory: [{
          ...
          book_ISBN: '987-987-2998-21-1',
          book_name: '大学室友',
          book_author: '测试',
          book_public_company: '测试',
        },{
          book_ISBN: '987-987-2190-21-1',
          book_name: '大学室友',
          book_author: '测试',
          book_public_company: '测试',
        },{
          book_ISBN: '99-987-2910-21-1',
          book_name: '大学室友',
          book_author: '测试',
          book_public_company: '测试',
        },{
